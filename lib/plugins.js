        ...
        if (pluginFactory.requires) {
            if (!Array.isArray(pluginFactory.requires)) {
                return {
                    ...
                    help: `PluginFactory 'requires' property is a ${typeof pluginFactory.requires} instead.`,
                }
            }
        ...
        if (pluginFactory.requiresRoles) {
            if (!Array.isArray(pluginFactory.requiresRoles)) {
                return {
                    ...
                    help: `PluginFactory 'requires' property is a ${typeof pluginFactory.requiresRoles} instead.`
                }
            }
    ...
    function unsafeInitialize (pluginFactory) {
        ...
        if (typeof instance !== "object") {
            return Fail({
                ...
                message: `pluginFactory instance from init function must be an object. Got ${String(instance)}, a ${typeof instance}, instead.`
            });
        }
